...
public class OptionsActivity extends Activity implements OnCheckedChangeListener {
    ...
    //private static final String SANDBOX_BASE_SERVER_URL = "http://btvaulttest.herokuapp.com";
    private static final String SANDBOX_BASE_SERVER_URL = "http://10.0.2.2:5002";
    private static final String PRODUCTION_BASE_SERVER_URL = "http://btvaulttest.herokuapp.com";
